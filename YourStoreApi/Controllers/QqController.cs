...
namespace YourStoreApi.Controllers
{
    ...
    public class QqController : BaseApiController
    {/*
        private readonly IOrderRepository orderRepository;
        private readonly IMapper mapper;

        public QqController(IOrderRepository _orderRepository, IMapper _mapper)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<Models.OderAggregate.Order>> CreateOrder(OrderDto orderDto)
        {
